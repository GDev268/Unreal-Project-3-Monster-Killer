...
#define UE_PROJECT_NAME Monster_Killer
#define UE_TARGET_NAME Monster_KillerEditor
#define UE_MODULE_NAME "Monster_Killer"
...
#define MONSTER_KILLER_API DLLEXPORT
